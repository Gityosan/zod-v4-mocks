...
::: warning v2.0.0–v2.0.4 の互換性問題
v2.0.0–v2.0.4 は Zod v4.3.5 未満で互換性の問題がありました（`ZodMAC`, `ZodCodec`, `ZodXor`, `ZodExactOptional` が存在しないためクラッシュ）。Zod v4.0.0–v4.3.4 をお使いの場合は **v2.1.0+** にアップグレードしてください。
:::
